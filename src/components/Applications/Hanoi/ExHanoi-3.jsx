...
export default function Exhanoi3() {
  ...
  useEffect(() => {
    ...
    if (diskNum > 0) {
      const movesCp = [];
      exhanoi_3('A', 'B', 'C', diskNum, movesCp);
      setMoves(movesCp);      
